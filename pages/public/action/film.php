...
<head>
    ...
    <title>Film Page | Wall Movie</title>
</head>
...
<body>
    ...
    <aside class="sidebar">
        <ul class="sidebar-side">
            <li><a href="../../../index.php"><i data-feather="home"></i> <span>&nbsp; Home</span></a></li>
            <li><a href="../../../index.php#recom"><i data-feather="check-square"></i> <span>&nbsp; Recommended Film</span></a></li>
            <li><a href="../../../index.php#cat-list"><i data-feather="list"></i> <span>&nbsp; Category List</span></a></li>
    ...
    <section class="recom" id="recom">
        <h1 class="title-recom">List <span>Film</span></h1>
