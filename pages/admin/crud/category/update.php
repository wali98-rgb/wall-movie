...
<head>
    ...
    <title>Update Category | Wall Movie</title>
</head>
<body>
    <!-- Check Login Start -->
    <?php
    ...
    <section class="section-admin">
        <main class="section-admin-content">
            <h1 class="section-title"> Update Category</h1>
                ...
                <form action="update-action.php" method="POST" class="form-section">
                    <table class="table">
                        <tr>
                            ...
                            <td width="80%">
                                <input type="hidden" name="id_category" id="" placeholder="Masukkan Nama Kategori" value="<?php echo $data['id_category'] ?>" required>
                                <input type="text" name="name_category" id="" placeholder="Masukkan Nama Kategori" value="<?php echo $data['nama_category'] ?>" required> <br>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <button type="submit" name="simpan" class="form-submit"><i data-feather="save"></i> &nbsp; <label for="">Ubah</label></button>
                            </td>
                            <td></td>
                        </tr>
                    </table>
